<%@ page import="java.util.List" %>
 <%@ page import="com.feedbackApplication.database.Feedback" %>
...
<html >
 ...
 <link rel="stylesheet" href="http://netdna.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css">
  ...
  <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
    	...
    	<div class="feedback">
			<form name="FeedsFilter" method="post" action="viewFeed.jsp">
			...
			<h2>FeedBack</h2>
			    ...
			    %>
			    	<tr>
			    		<td><%=feedback.getFeedbackSubmitter() %></td>
			...
			<input class="btn" type="submit" value="Back" name="submit">   
