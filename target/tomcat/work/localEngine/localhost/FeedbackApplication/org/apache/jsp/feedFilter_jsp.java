...
import com.feedbackApplication.database.Feedback;

public final class feedFilter_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String userName=(String)session.getAttribute("userName");
      ...
      out.write("\t\t\t<form name=\"FeedsFilter\" method=\"post\" action=\"viewFeed.jsp\">\r\n");
      ...
      out.write("\t\t\t    <tr>\r\n");
      out.write("\t\t\t                <th>Feedback Submitter</th>\r\n");
      ...
      out.write("\t\t\t    ");
			    	...
			    	List<Feedback> myFeedback = (List<Feedback>)request.getAttribute("myFeedback");
			    	for(Feedback feedback : myFeedback){
			    
      out.write("\r\n");
      out.write("\t\t\t    \t<tr>\r\n");
      out.write("\t\t\t    \t\t<td>");
      out.print(feedback.getFeedbackSubmitter() );
      out.write("</td>\r\n");
      out.write("\t\t\t    \t\t<td>");
      out.print(feedback.getFeedbackDate());
      out.write("</td>\r\n");
      out.write("\t\t\t    \t\t<td>");
      out.print(feedback.getFeedbackText() );
      out.write("</td>\r\n");
      out.write("\t\t\t    \t\t<td>");
      ...
      out.write("\t\t\t        \r\n");
      out.write("\t\t\t    </table>\r\n");
      out.write("\t\t\t<input class=\"btn\" type=\"submit\" value=\"Back\" name=\"submit\">   \r\n");
