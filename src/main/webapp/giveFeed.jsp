 ...
 <link rel="stylesheet" href="http://netdna.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css">
  ...
  <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
    	...
    	<div class="feedback">
			...
			<h2>Feedback</h2>
			<label for="first_name">Receiver Email <span>*</span></label>
			<input  type="email" id="ema" name="email" maxlength="50" size="30" required><span id="em" style="color:red"></span>
			...
			<label for="comments">Comments <span>*</span>
			<textarea  id="comment" name="comments" maxlength="1000" cols="25" rows="6" required></textarea><span id="cmnt" style="color:red"></span>
